...
void GLAPIENTRY gluQuadricCallback(GLUquadric* qobj, GLenum which,
                                       _GLUfuncptr fn);
...
void GLAPIENTRY gluCylinder(GLUquadric* qobj, GLfloat baseRadius,
                                GLfloat topRadius, GLfloat height,
                                GLint slices, GLint stacks);
void GLAPIENTRY gluDisk(GLUquadric* qobj, GLfloat innerRadius,
                            GLfloat outerRadius, GLint slices, GLint loops);
void GLAPIENTRY gluPartialDisk(GLUquadric* qobj, GLfloat innerRadius,
                                   GLfloat outerRadius, GLint slices,
                                   GLint loops, GLfloat startAngle,
                                   GLfloat sweepAngle);
void GLAPIENTRY gluSphere(GLUquadric* qobj, GLfloat radius, GLint slices,
                              GLint stacks);
/*END GLUES QUAD*/
