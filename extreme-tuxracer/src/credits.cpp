...
static credit_line_t credit_lines[] = 
{
    ...
    { NULL, "credits_text", "Mark Riddell" },
		...
		{ NULL, "credits_text", "Kristian Picon" },	
		{ NULL, "credits_text", "" },
    { NULL, "credits_h2", N_("Graphics") },
    { NULL, "credits_text", N_("Nicosmos (Logo, HUD and Interface)") },
    { NULL, "credits_text", N_("Kristian Picon (Objects, Skyboxes, Characters)") },
    { NULL, "credits_text", N_("Reinhard Niehoff (Trees)") },	
    { NULL, "credits_text", N_("Daniel Poeira and Kristian Picon (Papercuts Font)") },
    { NULL, "credits_text", "" },
