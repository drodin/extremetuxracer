...
tux_material pink_penguin {0.862745098	0.137254902	0.733333333} {0.5 0.5 0.5} 20.0
tux_material beak_color \
            {0.64 0.54 0.06} {0.4 0.4 0.4} 5

tux_material bow_color \
            {0.890196078	0.062745098	0.062745098} {0.4 0.4 0.4} 5			
...
proc makeBody { parent } {
    ...
    tux_surfaceproperty $torso_bl pink_penguin
...
tux_scale $torso_scl {0 0 0} { 0.90 1 0.9 }
...
tux_surfaceproperty $neck pink_penguin
...
tux_surfaceproperty $head pink_penguin
...
#Create bow
#
tux_sphere $head_org bow1 0.8
set bow1 "$head_org:bow1"
tux_surfaceproperty $bow1 bow_color
tux_translate $bow1 { -.1 .5 0 }
tux_rotate $bow1 x -90
tux_rotate $bow1 y -40
tux_scale $bow1 {0 0 0} { 0.115 0.06 0.2 }

tux_sphere $head_org bow2 0.8
set bow2 "$head_org:bow2"
tux_surfaceproperty $bow2 bow_color
tux_translate $bow2 { .1 .5 0 }
tux_rotate $bow2 x -90
tux_rotate $bow2 y 40
tux_scale $bow2 {0 0 0} { 0.115 0.06 0.2 }
...
tux_surfaceproperty $luparm pink_penguin
...
tux_surfaceproperty $ruparm pink_penguin
...
tux_surfaceproperty $llowarm pink_penguin
...
tux_surfaceproperty $rlowarm pink_penguin
...
tux_surfaceproperty $lhand pink_penguin
...
tux_surfaceproperty $rhand pink_penguin
...
tux_surfaceproperty $lhipball pink_penguin
...
tux_surfaceproperty $rhipball pink_penguin
...
tux_surfaceproperty $tail pink_penguin
