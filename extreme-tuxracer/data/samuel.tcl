...
tux_material gray_seal {0.4 0.4 0.4 } {0.5 0.5 0.5} 20.0
...
proc makeBody { parent } {
    ...
    tux_surfaceproperty $torso_bl gray_seal
    ...
    tux_scale $torso_wh1 {0 0 0} {0 0 0}
...
tux_scale $torso_scl {0 0 0} { 0.7 0.9 0.7 }
...
tux_surfaceproperty $neck gray_seal
...
tux_surfaceproperty $head gray_seal
tux_scale $head {0 0 0} {0.42 0.4 0.42}
...
tux_rotate $beak1 x +0
tux_scale $beak1 {0 0 0} { 0.23 .2 0.4 }
...
#create nose (says beak, but is actually nose)
tux_sphere $head_org bk3 0.66
set beak3 "$head_org:bk3"
tux_surfaceproperty $beak3 iris_color
tux_translate $beak3 { 0 -0.2 .7 }
tux_rotate $beak3 x +10
tux_scale $beak3 {0 0 0} { 0.1 .1 0.1 }

#create whiskers
tux_sphere $head_org ws1 0.66
set ws1 "$head_org:ws1"
tux_surfaceproperty $ws1 iris_color
tux_translate $ws1 { 0 -0.2 .65 }
tux_rotate $ws1 x +10
tux_scale $ws1 {0 0 0} { .3 0.01 0.01 }

tux_sphere $head_org ws2 0.66
set ws2 "$head_org:ws2"
tux_surfaceproperty $ws2 iris_color
tux_translate $ws2 { 0 -0.2 .65 }
tux_rotate $ws2 x +10
tux_rotate $ws2 z +20
tux_scale $ws2 {0 0 0} { .3 0.01 0.01 }

tux_sphere $head_org ws3 0.66
set ws3 "$head_org:ws3"
tux_surfaceproperty $ws3 iris_color
tux_translate $ws3 { 0 -0.2 .65 }
tux_rotate $ws3 x +10
tux_rotate $ws3 z -20
tux_scale $ws3 {0 0 0} { .3 0.01 0.01 }
...
tux_surfaceproperty $luparm gray_seal
...
tux_surfaceproperty $ruparm gray_seal
...
tux_surfaceproperty $llowarm gray_seal
...
tux_surfaceproperty $rlowarm gray_seal
...
tux_surfaceproperty $lhand gray_seal
...
tux_surfaceproperty $rhand gray_seal
...
tux_rotate $lthigh_xlate y +0
tux_rotate $lthigh_xlate x +3
...
tux_scale $lthigh {0 0 0} {0.2 0.30 0.07}

tux_sphere $lthigh_org lhipball 0.5
set lhipball "$lthigh_org:lhipball"
tux_surfaceproperty $lhipball gray_seal
tux_translate $lhipball {0.0 0.05 0.0}
tux_scale $lhipball {0 0 0} {0.2 0.18 0.09}
...
tux_scale $rthigh {0 0 0} {0.2 0.30 0.07}

tux_sphere $rthigh_org rhipball 0.5
set rhipball "$rthigh_org:rhipball"
tux_surfaceproperty $rhipball gray_seal
tux_translate $rhipball {0.0 0.05 0.0}
tux_scale $rhipball {0 0 0} {0.2 0.18 0.09}
...
tux_scale $lcalf {0 0 0} {0.2 0.18 0.06}
...
tux_scale $rcalf {0 0 0} {0.2 0.18 0.06}
...
tux_surfaceproperty $tail gray_seal
tux_scale $tail {0 0 0} {0 0 0}
